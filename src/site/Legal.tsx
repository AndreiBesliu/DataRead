...
export default function Legal({ kind }: { kind: 'termeni' | 'confidentialitate' }) {
  ...
  return (
    <main data-page={`legal-${kind}`} style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px' }}>
      <div role="note" style={{ background: '#fff7e0', color: '#5a4500', border: '1px solid #e6c75a', borderRadius: 'var(--radius)', padding: '10px 14px', fontWeight: 700, fontSize: 14, marginBottom: 24 }}>
